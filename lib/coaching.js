...
function clampReport(text, maxChars) {
  return String(text).slice(0, Number(maxChars) || 1000);
}
...
module.exports = { buildPrompt, buildSelectionPrompt, clampReport, coachingKnowledge, personalityInstruction, removeUnscheduledBreakAdvice };
